...
import { PORT, FULL_DOMAIN_1 } from '../config/mongo.config.js'; // Configuración del puerto y dominio.
import mongoRoutes from '../routes/mongodb.routes.js'; // Rutas de la API para MongoDB.
